...
import { AccountProviderIcon, AccountProviderIconName, forAccount } from '../components/AccountProviderIcon'
import { Message } from '../components/Message'
import { SafeAreaView } from '../components/SafeAreaView'
import { RegularHeader } from '../components/SpecialHeader'
...
export class BaseAppMenu extends React.Component<AppMenuProps> {
...
function generateStats(stats: PromiseState<UserAccountStats>): PromiseState<AppMenuStats> {
   ...
   function mapStateToProps(state: State) {
      ...
      return {
        currentAccount: {
          ...
          icon : forAccount(state.navigation.currentAccount),
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(BaseAppMenu)
